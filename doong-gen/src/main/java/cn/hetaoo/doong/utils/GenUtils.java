...
public class GenUtils {
	...
	public static String getFileName(String template, String className, String packageName){
		...
		if(template.contains("Dao.java.vm")){
			return packagePath + "cn/hetaoo/doong/dao" + File.separator + className + "Dao.java";
		}
		
		if(template.contains("Dao.xml.vm")){
			return packagePath + "cn/hetaoo/doong/dao" + File.separator + className + "Dao.xml";
		}
		
		if(template.contains("Service.java.vm")){
			return packagePath + "cn/hetaoo/doong/service" + File.separator + className + "Service.java";
		}
		
		if(template.contains("ServiceImpl.java.vm")){
			return packagePath + "cn/hetaoo/doong/service" + File.separator + "impl" + File.separator + className + "ServiceImpl.java";
		}
		
		if(template.contains("Controller.java.vm")){
			return packagePath + "cn/hetaoo/doong/controller" + File.separator + className + "Controller.java";
		}
